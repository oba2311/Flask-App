...
date_string_array = ['2018-05-01', '2018-05-03', '2018-05-04', '2018-05-05', '2018-05-06', '2018-05-07', '2018-05-08',
...
colorscale = [[0, 'rgb(255,255,255)'], [0.25, 'rgb(255,255,255)'], [0.25, 'rgb(255,0,0)'], [0.5, 'rgb(255,0,0)'],
              [0.5, 'rgb(255,255,0)'], [0.75, 'rgb(255,255,0)'], [0.75, 'rgb(0,254,0)'], [1, 'rgb(0,254,0)']]
num = len(pp_array)
...
dates_list = [datetime.strptime(date, '%Y-%m-%d').date() for date in
              date_string_array]  ##Convert date string objects to datetime objects
...
pt = ff.create_annotated_heatmap(z, x=x, y=y, annotation_text=days, colorscale=colorscale, font_colors=['black'],
                                 hoverinfo='text', text=textinfo)  ##Figure
